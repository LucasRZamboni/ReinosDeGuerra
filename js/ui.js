(function () {
  ...
  function bindDynamic() {
    ...
    if (view === "admin") {
      ...
      $("#saveEnemyRoster")?.addEventListener("click",()=>{const f=new FormData($("#adminWorldForm"));G.updateSettings({enemiesEnabled:true,enemyCount:Math.max(5,Number(f.get("enemyCount"))||5)});G.syncEnemies();});
  ...
  const renderers = { overview, village, army, villages, commands, ranking, achievements, map, reports, settings, admin };
