    ...
    if (view === "admin") {
      ...
      $("#adminWorldForm").onsubmit = (e) => {
        ...
        G.updateSettings({
          ...
          barbarianSpawn:{enabled:f.get("spawnEnabled")==="on",intervalMinutes:Number(f.get("spawnInterval"))||30,maxNewVillages:Number(f.get("spawnMax"))||0,perCycle:Number(f.get("spawnPerCycle"))||1,bonusChance:Number(f.get("spawnBonus"))||0},
        });
      };
