(function () {
  ...
  function bindDynamic() {
    ...
    if (view === "admin") {
      ...
      $("#bulkSelectBarbs")?.addEventListener("click",()=>bulkPick(v=>v&&!v.owner&&!v.bonusType));
      ...
      $("#saveEnemyBehavior")?.addEventListener("click",()=>{const f=new FormData($("#adminWorldForm"));G.updateSettings({enemyRules:{...(G.state.settings.enemyRules||{}),canAttackPlayers:f.get("enemyAttackPlayers")==="on",canAttackBarbarians:f.get("enemyAttackBarbs")==="on",canConquer:f.get("enemyConquer")==="on",maxVillagesPerEnemy:Number(f.get("enemyMaxVillages"))||12,attackRadius:Number(f.get("enemyRadius"))||25,canRecruitTroops:f.get("enemyRecruit")==="on",canBuild:f.get("enemyBuild")==="on",canRecruitNobles:f.get("enemyNobles")==="on",canUseSiege:f.get("enemySiege")==="on",recruitmentBatch:Number(f.get("enemyBatch"))||20}});});
      $("#saveEnemyRoster")?.addEventListener("click",()=>{const f=new FormData($("#adminWorldForm"));G.updateSettings({enemiesEnabled:f.get("enemiesEnabled")==="on",enemyCount:Number(f.get("enemyCount"))||0});G.syncEnemies();});
